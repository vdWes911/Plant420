...
/* Populate broadband and infrared with the latest values */
  ...
  //uint16_t mixedLightValue = *broadband;
  //uint16_t irLightValue = *infrared;
  
  //tsl.getLuminosity(mixedLightPointer, irLightPointer);

  Serial.print("Mixed Light measurement: ");
  Serial.println(broadband);

  Serial.print("IR Light measurement: ");
